                ...
                {role === "Client"
                    ? <nav className="flex flex-col justify-between h-full p-4 pb-24">
                        <div className="flex flex-col gap-3">
                            <a href="#" className="hover:bg-[#1e2a33] px-3 py-2 rounded-lg">Mi perfil</a>
                            <a href="#" className="hover:bg-[#1e2a33] px-3 py-2 rounded-lg">Mis Reservas</a>
                            <a href="#" className="hover:bg-[#1e2a33] px-3 py-2 rounded-lg">Reservar</a>
                            <a href="#" className="hover:bg-[#1e2a33] px-3 py-2 rounded-lg">Soporte</a>
                        </div>
                        <a href="#" className="hover:bg-[#1e2a33] px-3 py-2 rounded-lg text-red-300 cursor-pointer">Cerrar sesión</a>
                    </nav>
                    : <nav className="flex flex-col justify-between h-full p-4 pb-24">
                        <div className="flex flex-col gap-3">
                            <a href="#" className="hover:bg-[#1e2a33] px-3 py-2 rounded-lg">Dashboard Admin</a>
